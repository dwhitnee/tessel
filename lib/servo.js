...
module.exports = function( tessel, id, port ) {
  ...
  var Servo = {
    ...
    move: function( pos ) {
      ...
      servos.move( Servo.id, Servo.position, Servo.doneMoving );
      console.log("servo at " + Servo.position);
    },
    doneMoving: function( a,b,c ) {
      console.log("servo done");
    },
